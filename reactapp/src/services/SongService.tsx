...
const getSongsByArtist = async (id: number, limit: number) => {
    const response = await axiosInstance.get(`songs/getSongsByArtist/${id}`, {
        params: {
            limit
        }
    })
...
export { getAllSongs, getSongById, getPlayList, getSongsByArtist }